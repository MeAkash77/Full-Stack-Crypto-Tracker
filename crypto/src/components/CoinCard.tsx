...
const CoinCard: FC<CoinCardProps> = ({ coin, onClick }) => {
  ...
  const toggleWatchlist = async () => {
    ...
    await setDoc(ref, { coins: updatedCoins }, { merge: true });
  };

  return (
    <motion.div
      onClick={onClick} // ✅ Use onClick on the wrapper
      className="relative bg-gradient-to-b from-gray-800 to-gray-900 text-gray-100 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-700 overflow-hidden cursor-pointer"
